...
public class DialogHelp {
    ...
    public static AlertDialog.Builder getDialog(Context context, int themeId) {
    ...
    public static AlertDialog.Builder getMessageDialog(Context context, String message, DialogInterface.OnClickListener onClickListener) {
        return getMessageDialog(context, message, onClickListener, null);
    }

    public static AlertDialog.Builder getMessageDialog(Context context, String message, DialogInterface.OnClickListener onClickListener, View customView) {
    ...
    public static AlertDialog.Builder getMessageDialog(Context context, String message, DialogInterface.OnClickListener onClickListener, View customView, int themeId) {
        AlertDialog.Builder builder = getDialog(context, themeId);
        builder.setMessage(message);
        if (onClickListener != null) {
            builder.setPositiveButton("确定", onClickListener);
        }
    ...
    public static AlertDialog.Builder getMessageDialog(Context context, View customView) {
        return getMessageDialog(context, null, null, customView);
    }

    public static AlertDialog.Builder getMessageDialog(Context context, View customView, int themeId) {
        return getMessageDialog(context, null, null, customView, themeId);
    }
