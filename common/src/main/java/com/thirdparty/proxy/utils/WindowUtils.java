...
public class WindowUtils {
    ...
    public static boolean hasInternet() {
        boolean flag;
        NetworkInfo networkInfo = ((ConnectivityManager) BaseApplication.getInstance().getSystemService(
    ...
    public static boolean isSoftKeyboardShow() {
        return ((InputMethodManager) BaseApplication.getInstance().getSystemService(
                Context.INPUT_METHOD_SERVICE)).isAcceptingText();
    }
