 ...
 * 修改:
 */
public class InfoEnFragment extends InfoFragment<InfoConstract.Presenter>
    ...
    private IssueView checkSpecialEmpty() {
        ...
        String dateAvailable = mInfoEtDateAvailable.getText().toString().trim();
        if (TextUtils.isEmpty(dateAvailable)) {
    ...
    protected void fillTestData() {
        ...
        mInfoEtDateOfBirth.setText("1989/4/25");
        mInfoEtPassportNo.setText("EU66666666");
        mInfoEtGraduateSchool.setText("Massachusetts Institute of Technology");
        mInfoEtMajor.setText("Automation Major");
        mInfoEtEmail.setText("diadib@gmail.com");
        mInfoEtMobile.setText("13167846323");
        mInfoEtTelephone.setText("010-88888888");
        mInfoEtCurrentAddress.setText(
                "Room 401, Lane NO 23-30, Guangxindonglu Road 205, Haicheng Street, Yumen village, Longwan District, Wenzhou, Zhejiang Province");
        mInfoEtPostCode.setText("387400");
        mInfoEtEmergencyContact.setText("Adelaide");
        mInfoEtRelationship.setText("friend");
        mInfoEtTelephoneNo.setText("13167846323");
        mInfoEtYesFriendName.setText("Tom");
        ...
        exp.referee = new Candidate.Contact("张三", "领导", "13167846323");
