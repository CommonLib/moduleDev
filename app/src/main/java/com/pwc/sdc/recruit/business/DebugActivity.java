...
public class DebugActivity extends Activity {
    ...
    protected void initView() {
        ...
        mDebugTvProductionUrl.setText(AppConfig.PRO_ENV_URL);
        mDebugTvInternalUrl.setText(AppConfig.DEV_ENV_URL);
        mDebugTvOtherUrl.setText(AppConfig.BASE_URL);
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.dialog_btn_confirm:
                if (mDebugCvNoConnection.isChecked()) {
                    ...
                    SharedPreHelper.put(PwcApplication.getInstance(), Constants.MODE_CONNECTION,
                ...
                if (httpUrl != null) {
                    ...
                    PwcApplication.showToast("Url格式不正确");
                    return;
                }
                finish();
                break;
