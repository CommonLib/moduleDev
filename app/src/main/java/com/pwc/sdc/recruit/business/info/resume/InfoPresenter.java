 ...
 * 修改:
 */
public class InfoPresenter extends BasePresenter<InfoActivity, InfoMode>
        implements InfoConstract.Presenter {
    ...
    public void next() {
        ...
        if (issueView != null) {
            ...
            if (!TextUtils.isEmpty(issueView.issueMessage)) {
                mViewLayer.showAlertDialog(issueView.issueMessage);
            } else {
